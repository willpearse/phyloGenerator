...
sequenceDisplay(seqList, spNames, genes, chkSeqs)
...
class PhyloGenerator:
    ...
    def dnaChecking(self, tolerance=0.1):
        ...
        for i in range(len(self.genes)):
            tempSeqs = [x[i] for x in self.sequences]
            self.dnaCheck.append(checkSequenceList(tempSeqs, tolerance=self.tolerance, method="quantileDetect"))
